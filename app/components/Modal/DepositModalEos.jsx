		...
		return (
			<div>
				...
				<div className="grid-block container-row">
					<div style={{paddingRight: '1rem'}}>
						<CopyButton text={this.props.depositMemo} className={'copyIcon'} />
					</div>
					<div style={{wordBreak: 'break-word'}}>
						<div
							style={{
				...
				<h6>
					<b>IMPORTANT:</b> Send only EOS to this deposit address. Sending less
					than 0.1 EOS or any other currency to this address may result in the
...
export default class DepositModal extends React.Component {
	...
	getDepositAddress() {
		fetch('https://gateway.dev.meta-exchange.vision/api')
			.then((response) => {
				fetch('https://gateway.dev.meta-exchange.vision/api/wallet/init/eos', {
					method: 'POST',
					headers: {
