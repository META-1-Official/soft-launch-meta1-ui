			...
			<span>
				...
				<span>
					{debtBalanceObj.id ? (
						...
						<FormattedAsset amount={0} asset={quoteAssetObj.get('id')} />
					)}
				</span>
			</span>
		</span>
			...
			<span>
				...
				<span>
					{collateralBalanceObj.id ? (
						...
						<FormattedAsset amount={0} asset={backingAssetObj.get('id')} />
					)}
				</span>
			</span>
		</span>
		...
		<div style={{textAlign: 'left'}}>
			{disableHelp ? null : (
				...
				>
					<HelpContent
						path={
							'components/' +
							(isPredictionMarket ? 'BorrowModalPrediction' : 'BorrowModal')
						}
			...
			<Form className="full-width" layout="vertical">
				<AmountSelector
					...
					tabIndex={1}
					lockStatus={
						unlockedInputType == 'debt' || isRatioLocked ? false : true
					}
				...
				<AmountSelector
					...
					tabIndex={2}
					lockStatus={
						unlockedInputType == 'collateral' || isRatioLocked ? false : true
					}
