	...
	render() {
		return (
			<div>
				...
				<h6>
					<b>IMPORTANT:</b> Send only BNB to this deposit address. Sending less
					than 0.1 BNB or any other currency to this address may result in the
...
export default class DepositModal extends React.Component {
	...
	getDepositAddress() {
		// fetch("https://api.dev.meta1.io/api-gateways/bnb")
		//     .then(response => {
		fetch('https://gateway.dev.meta1.io/api/wallet/init/bnb', {
			method: 'POST',
			headers: {
