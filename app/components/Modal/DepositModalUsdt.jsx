	...
	render() {
		return (
			<div>
				...
				<h6>
					<b>IMPORTANT:</b> Send only USDT (ERC20) to this deposit address.
					Sending less than 1 USDT or any other currency to this address may
...
export default class DepositModal extends React.Component {
	...
	getDepositAddress() {
		fetch('https://gateway.dev.meta-exchange.vision/api-gateways/eth')
			.then((response) => {
				fetch('https://gateway.dev.meta-exchange.vision/api/wallet/init/eth', {
					method: 'POST',
					headers: {
