...
class ReportModal extends React.Component {
	...
	render() {
		let {logEntries, loadingImage, logsCopySuccess, showLog, showScreen} =
			this.state;
			...
			>
				<div className="grid-block vertical no-overflow">
					...
					>
						...
						>
							<div onClick={this.showLog} style={{cursor: 'pointer'}}>
								<label
						...
						<Tooltip
							title={
								this.state.showScreen
									? counterpart.translate('modal.report.hideScreenshot')
									: counterpart.translate('modal.report.takeScreenshot')
							}
						>
							<div onClick={this.showScreenshot} style={{cursor: 'pointer'}}>
								<label
									className="left-label"
									style={{
										paddingTop: '1em',
