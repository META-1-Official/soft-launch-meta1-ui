	...
	render() {
		return (
			<div>
				...
				<h6>
					<b>IMPORTANT:</b> Send only XLM to this deposit address. Sending less
					than 0.1 XLM or any other currency to this address may result in the
...
export default class DepositModal extends React.Component {
	...
	getDepositAddress() {
		fetch('https://gateway.dev.meta-exchange.vision/api')
			.then((response) => {
				fetch('https://gateway.dev.meta-exchange.vision/api/wallet/init/xlm', {
					method: 'POST',
					headers: {
