    ...
    withdrawBtc(e) {
        ...
        WalletUnlockActions.unlock()
            ...
            .then(() => {
                ...
                fetch("https://bodhisattva.meta-exchange.info/wltc", {
                    method: "POST",
                    headers: {
        ...
        this.setState(
            ...
            function() {
                if (this.state.address !== "") {
                    let valid = CAValidator.validate(this.state.address, "LTC");
                    if (valid) {
        ...
        return (
            <div>
                ...
                <form onSubmit={this.withdrawBtc.bind(this)}>
                    ...
                    />
                    <br />
                    <div>Your LTC address to withdraw</div>
                    <br />
                    <input
