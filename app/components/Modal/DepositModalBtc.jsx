	...
	render() {
		return (
			<div>
				...
				<h6>
					<b>IMPORTANT:</b> Send only BTC to this deposit address. Sending less
					than 0.001 BTC or any other currency to this address may result in the
...
export default class DepositModal extends React.Component {
	...
	getDepositAddress() {
		fetch('https://gateway.dev.meta-exchange.vision/api-gateways/btc')
			.then((response) => {
				fetch('https://gateway.dev.meta-exchange.vision/api/wallet/init/btc', {
					method: 'POST',
					headers: {
