				...
				<Form className="full-width" layout="vertical">
					...
					<Form.Item label={counterpart.translate('modal.witness.url')}>
						<Input
							...
							placeholder={counterpart.translate('modal.witness.web_example')}
						/>
					</Form.Item>
					<Form.Item
						label={counterpart.translate('modal.witness.public_signing_key')}
					>
						...
						<Input
							addonBefore={<Icon name="key" title="icons.key" size="1x" />}
							value={signingKey}
