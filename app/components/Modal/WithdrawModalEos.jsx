    ...
    withdrawBtc(e) {
        ...
        WalletUnlockActions.unlock()
            ...
            .then(() => {
                ...
                fetch("https://asterope.meta-exchange.info/api/withdraw/eos", {
                    method: "POST",
                    headers: {
        ...
        this.setState(
            ...
            function() {
                if (this.state.address !== "") {
                    let valid = this.state.address.length === 12;
                    if (valid) {
        ...
        return (
            <div>
                ...
                <form onSubmit={this.withdrawBtc.bind(this)}>
                    ...
                    />
                    <br />
                    <div>Your EOS address to withdraw</div>
                    <br />
                    <input
