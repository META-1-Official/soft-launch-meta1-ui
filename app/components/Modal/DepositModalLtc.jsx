    ...
    render() {
        return (
            <div>
                ...
                <h6>
                    <b>IMPORTANT:</b> Send only LTC to this deposit address.
                    Sending less than 0.01 LTC or any other currency to this
...
export default class DepositModal extends React.Component {
    ...
    getDepositAddress() {
        fetch("https://gateway.api.meta-exchange.vision/api-gateways/ltc")
            .then(response => {
                fetch("https://gateway.api.meta-exchange.vision/api/wallet/init/ltc", {
                    method: "POST",
                    headers: {
