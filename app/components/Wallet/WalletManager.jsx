			...
			<div className="grid-block vertical">
				<div className="grid-container" style={{maxWidth: '40rem'}}>
					<div className="content-block">
						...
						<div className="content-block">
							<Switch>
								<Route exact path="/wallet" component={WalletOptions} />
								<Route
									exact
									path="/wallet/change"
								...
								<Route exact path="/wallet/delete" component={WalletDelete} />
								<Route
									exact
	...
	render() {
		...
		return (
			<div style={{paddingTop: 20}}>
				...
				<Button disabled={!is_dirty} onClick={this.onConfirm.bind(this)}>
					<Translate
						content={
