...
class AccountRegistrationConfirm extends React.Component {
	...
	toggleConfirmedTerms3(e) {
		if (e.target.checked) {
			if (!this.state.voiceItClientHasInitialized || !this.state.voiceItPhrases)
				return;
		...
		return (
			<React.Fragment>
				<Helmet
					...
					onChangeClientState={(_, addedTags) => this.onInjectScript(addedTags)}
				/>
						...
						<Form.Item>
							...
							<div id="myModal" className="custom-modal">
								<div className="custom-modal-content">
									...
									<p>
										The www.meta1.io website located at https://meta1.io is a
										copyrighted work belonging to META1. Certain features of the
									...
									<p>
										...
										conditions that oversee your use of the Site. BY LOGGING
										INTO THE SITE, YOU ARE BEING COMPLIANT THAT THESE TERMS and
										you represent that you have the authority and capacity to
										enter into these Terms. YOU SHOULD BE AT LEAST 18 YEARS OF
										AGE TO ACCESS THE SITE. IF YOU DISAGREE WITH ALL OF THE
										PROVISION OF THESE TERMS, DO NOT LOG INTO AND/OR USE THE
										SITE.
									</p>
									...
									<p>
										...
										for any change, interruption, or termination of the Site or
										any part.
									</p>
									...
									<p>
										...
										suppliers. Note that these Terms and access to the Site do
										not give you any rights, title or interest in or to any
									...
									<p>
										...
										display advertisements for third-parties.  Such Third-Party
										Links & Ads are not under the control of Company, and
										Company is not responsible for any Third-Party Links & Ads. 
										Company provides access to these Third-Party Links & Ads
										only as a convenience to you, and does not review, approve,
										monitor, endorse, warrant, or make any representations with
										respect to Third-Party Links & Ads.  You use all Third-Party
										Links & Ads at your own risk, and should apply a suitable
									...
									<p>
										...
										whether provided by you or by others.  You agree that
									...
									<p>
										...
										to, the Site. If you are a California resident, you hereby
										waive California civil code section 1542 in connection with
										the foregoing, which states: "a general release does not
									...
									<p>
										...
										website, www.meta1.io uses ‘cookies’. These cookies are used
										to store information including visitors’ preferences, and
									...
									<p>
										...
										incapability to use the site even if company has been
										advised of the possibility of such damages.  Access to and
										use of the site is at your own discretion and risk, and you
									...
									<p>
										...
										rights to use the Site at any time for any reason at our
										...
										the Site will terminate immediately.  You understand that
										any termination of your Account may involve deletion of your
										User Content associated with your Account from our live
										databases.  Company will not have any liability whatsoever
									...
									<p>
										...
										our online Site who are repeated infringers of intellectual
										...
										to 17 U.S.C. § 512(c)) must be provided to our designated
										Copyright Agent:
									</p>
									...
									<p>
										...
										dispatch of an e-mail notice to you or thirty (30) calendar
									...
									<p>
										...
										cannot be resolved informally or in small claims court shall
										be resolved by binding arbitration on an individual basis
										under the terms of this Arbitration Agreement.  Unless
										otherwise agreed to, all arbitration proceedings shall be
										held in English.  This Arbitration Agreement applies to you
										and the Company, and to any subsidiaries, affiliates,
									...
									<p>
										...
										the requested relief.  A Notice to the Company should be
										sent to: Arizona, USA. After the Notice is received, you and
										...
										has determined the amount of the award to which either party
										is entitled.
									</p>
									...
									<p>
										...
										offers arbitration as set forth in this section.  If AAA is
										not available to arbitrate, the parties shall agree to
										select an alternative ADR Provider.  The rules of the ADR
										Provider shall govern all aspects of the arbitration except
										to the extent such rules are in conflict with the Terms. 
										The AAA Consumer Arbitration Rules governing the arbitration
										are available online at adr.org or by calling the AAA at
										1-800-778-7879.  The arbitration shall be conducted by a
										single, neutral arbitrator.  Any claims or disputes where
										...
										hearings. Any judgment on the award rendered by the
										...
										will pay you the greater of the award or $2,500.00.  Each
										party shall bear its own costs and disbursements arising out
										of the arbitration and shall pay an equal share of the fees
									...
									<p>
										...
										The arbitration shall not involve any personal appearance by
										the parties or witnesses unless otherwise agreed by the
										parties.
									</p>
									...
									<p>
										...
										be consolidated with any other matters or joined with any
										other cases or parties.  The arbitrator shall have the
										authority to grant motions dispositive of all or part of any
										claim.  The arbitrator shall have the authority to award
										monetary damages, and to grant any non-monetary remedy or
										relief available to an individual under applicable law, the
										AAA Rules, and the Terms.  The arbitrator shall issue a
										written award and statement of decision describing the
										essential findings and conclusions on which the award is
										based.  The arbitrator has the same authority to award
										relief on an individual basis that a judge in a court of law
										would have.  The award of the arbitrator is final and
									...
									<p>
										...
										efficient and less expensive than rules applicable in a
										...
										COMPANY WAIVE ALL RIGHTS TO A JURY TRIAL, instead electing
									...
									<p>
										...
										arbitration proceeding shall be strictly confidential.  The
									...
									<p>
										...
										be waived by the party against whom the claim is asserted. 
										Such waiver shall not waive or affect any other portion of
									...
									<p>
										...
										patent, copyright, trademark or trade secrets shall not be
									...
									<p>
										...
										of the courts located within Netherlands County, California,
										for such purposes.
									</p>
									...
									<p>
										...
										provision of these Terms shall not operate as a waiver of
										such right or provision. The section titles in these Terms
										...
										invalid or unenforceable, the other provisions of these
									...
									<p>
										...
										of other third-parties. You are not permitted to use these
