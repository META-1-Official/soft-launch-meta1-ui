				...
				<Form.Item className="checkbox-group">
					...
					<div id="myModal" class="custom-modal">
						<div class="custom-modal-content">
							...
							<p>
								The www.dev.meta1.io website located at https://dev.meta1.io is
								a copyrighted work belonging to META1. Certain features of the
							...
							<p>
								...
								website, www.dev.meta1.io uses ‘cookies’. These cookies are used
							...
							<p>
								...
								relief.  A Notice to the Company should be sent to: Arizona,
								USA. After the Notice is received, you and the Company may
							...
							<p>
								...
								unless the parties agree otherwise.  If you reside outside of
								the U.S., the arbitrator shall give the parties reasonable
								notice of the date, time and place of any oral hearings. Any
								judgment on the award rendered by the arbitrator may be entered
								in any court of competent jurisdiction.  If the arbitrator
								grants you an award that is greater than the last settlement
