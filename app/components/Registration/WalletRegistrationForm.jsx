...
import {ChainStore, FetchChain} from 'meta1-vision-js/es';
...
import {notification, Form, Button, Select, Alert, Tooltip} from 'antd';
...
class WalletRegistrationForm extends React.Component {
	...
	constructor() {
		...
		this.onPasswordValidationChange =
			this.onPasswordValidationChange.bind(this);
	}
			...
			<Form layout={'vertical'} onFinish={this.onSubmit}>
				...
				{registrar && !isLTM ? (
					<Form.Item>
						<Alert
							type="error"
							description={<Translate content="wallet.must_be_ltm" />}
						/>
					</Form.Item>
				) : null}
