		...
		return (
			<div className="text-left">
				<div className="confirm-checks">
					<Translate component="h3" content="registration.createAccountTitle" />
					{WalletRegistrationConfirm.renderWarning()}
				</div>
				<div
					className="checkbox-block"
					onClick={() => this.props.toggleConfirmed('checkboxRemember')}
				>
					<span>
						<Icon
							className={`${
								this.props.checkboxRemember ? 'checkbox-active' : ''
							} checkbox`}
							name="checkmark"
						/>
					</span>
				...
				<div
					className="checkbox-block"
					onClick={() => this.props.toggleConfirmed('checkboxUploaded')}
				>
					<span>
						<Icon
							className={`${
								this.props.checkboxUploaded ? 'checkbox-active' : ''
							} checkbox`}
							name="checkmark"
						/>
					</span>
				...
				<div
					className="checkbox-block"
					onClick={() => this.props.toggleConfirmed('checkboxRecover')}
				>
					<span>
						<Icon
							className={`${
								this.props.checkboxRecover ? 'checkbox-active' : ''
							} checkbox`}
							name="checkmark"
						/>
					</span>
