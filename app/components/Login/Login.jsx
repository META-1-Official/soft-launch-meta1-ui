						...
						<div className="v-align login-page-selector">
							...
							>
								...
								<WalletLogin
									active={activeWalletModel}
									onChangeActive={() =>
										!activeWalletModel ? this.changeActiveModel(true) : null
									}
									goToAccountModel={() => this.changeActiveModel(false)}
							...
							>
								...
								<AccountLogin
									...
									history={this.props.history}
									onChangeActive={() =>
										activeWalletModel ? this.changeActiveModel(false) : null
									}
									goToWalletModel={() => this.changeActiveModel(true)}
								/>
							</div>
						</div>
					</div>
