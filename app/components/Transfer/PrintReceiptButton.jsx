...
const printReceipt = ({data, parsePrice}) => {
	...
	pdf.autoTable({
		body: [
			...
			[
				{
					content: counterpart.translate('invoice.paid_by').toUpperCase(),
					styles: {fontStyle: 'bold'},
				},
				counterpart.translate('invoice.date'),
				timestamp,
			],
			[fromName, counterpart.translate('invoice.transaction'), transactionId],
			[
				{
					content: counterpart.translate('invoice.note').toUpperCase(),
					styles: {fontStyle: 'bold'},
				},
				'',
				'',
