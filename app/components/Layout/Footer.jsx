...
class Footer extends React.Component {
	...
	constructor(props) {
		...
		this._showAccessSettingsTooltip =
			this._showAccessSettingsTooltip.bind(this);
	}
	...
	shouldComponentUpdate(nextProps, nextState) {
		return (
			...
			nextState.isReportModalVisible !== this.state.isReportModalVisible ||
			...
			fetch(
				...
				.then(
					function (json) {
						...
						let isReleaseCandidate = APP_VERSION.indexOf('rc') !== -1;
	...
	render() {
		...
		return (
			<div>
					...
					<div className="align-justify grid-block">
						<div className="grid-block">
							<div
								...
								onClick={
									state.newVersion ? this.downloadVersion.bind(this) : null
								}
								{...logoProps}
							>
								{state.newVersion && (
									<Icon
										name="download"
										title={counterpart.translate('icons.download', {
							...
							<span>
								<div className="grid-block">
									<Tooltip
										overlay={
											<div>
												Please understand that you are responsible for making
												your own backup&hellip;
											</div>
										}
									>
										<a
						...
						{block_height ? (
							<div className="grid-block shrink">
									...
									>
										<div className="footer-status">
											...
											{!connected ? (
												...
												<span className="success">{activeNode.name}</span>
											)}
										</div>
								...
								<div className="grid-block">
									<Tooltip
										title={counterpart.translate('tooltip.debug_report')}
										placement="topRight"
										mouseEnterDelay={0.5}
									>
										<div
				...
				>
					<AccessSettings nodes={this.props.defaults.apiServer} popup={true} />
