			...
			>
				...
				{locked ? (
					<li
						...
						onClick={this.props.onNavigate.bind(this, '/registration/')}
					>
						<div className="table-cell">
				...
				].map(({subURL, disabled, mainText, subText, mainCallback}, index) => (
					<li
						key={index}
						className={cnames({
								...
								<span
									onClick={
										disabled
											...
											: (event) => {
													event.stopPropagation();
													this.props.onNavigate.bind(this, subURL)(event);
											  }
									}
