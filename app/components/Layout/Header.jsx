		...
		const advanced = {
			[SUBMENUS.ADVANCED]: (
				...
				>
					<li
						className="divider parent-item"
						onClick={this._toggleDropdownSubmenuAdvanced.bind(this, undefined)}
					>
						<div className="table-cell">
							<span className="parent-item-icon">&lt;</span>
							<Translate
		...
		const deposit = {
			[SUBMENUS.DEPOSIT]: (
				...
				>
					<li
						className="divider parent-item"
						onClick={this._toggleDropdownSubmenuDeposit.bind(this, undefined)}
					>
						<div className="table-cell">
							<span className="parent-item-icon">&lt;</span>
							<Translate
                    ...
                    <ul className="menu-bar">
                        ...
                        <li className="column-hide-small">
                            <a
                                style={{flexFlow: 'row'}}
                                className={cnames(
                                    active.indexOf('market/') !== -1 ? null : 'column-hide-xxs',
                                    {
                        ...
                        <li className="column-hide-small">
                            <a
                                style={{flexFlow: 'row'}}
                                className={cnames(
                                    active.indexOf('explorer') !== -1 ? null : 'column-hide-xs',
                                    {
