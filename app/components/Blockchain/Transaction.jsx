...
const TranslateBoolean = ({value, ...otherProps}) => (
	<Translate content={`boolean.${value ? 'true' : 'false'}`} {...otherProps} />
);
			...
			switch (
				...
				case 'limit_order_create':
					...
					rows.push(
						<tr key={key++}>
							<td>
								...
								>
									<Translate component="span" content="exchange.buy_min" />
								</Tooltip>
							</td>
							<td>
								<FormattedAsset
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="transaction.seller" />
							</td>
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="transaction.expiration" />
							</td>
							<td>
								<FormattedDate
				...
				case 'limit_order_cancel':
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="transaction.order_id" />
							</td>
							<td>{op[1].order}</td>
						</tr>
					);
				...
				case 'call_order_update':
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="transaction.delta_debt" />
							</td>
							<td>
								<FormattedAsset
					...
					if (
						...
						rows.push(
							<tr key={key++}>
								...
								<td>{op[1].extensions.target_collateral_ratio / 1000}</td>
							</tr>
						);
					}
				...
				case 'key_create':
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="explorer.block.key" />
							</td>
					...
					if (op[1].new_options) {
						if (op[1].new_options.voting_account) {
							...
							rows.push(
								<tr key={key++}>
									<td>
										<Translate component="span" content="account.votes.proxy" />
									</td>
									<td>
										{this.linkToAccount(op[1].new_options.voting_account)}
									</td>
								</tr>
							);
						} else {
				...
				case 'account_upgrade':
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="explorer.block.lifetime" />
							</td>
				...
				case 'asset_create':
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="transaction.market_fee" />
							</td>
				...
				case 'asset_update_bitasset':
					...
					if (op[1].new_options.core_exchange_rate) {
						rows.push(
							<tr key={key++}>
								<td>
									<Translate component="span" content="markets.core_rate" />
								</td>
								<td>
									<FormattedPrice
										base_asset={
											op[1].new_options.core_exchange_rate.base.asset_id
										}
										quote_asset={
											op[1].new_options.core_exchange_rate.quote.asset_id
										}
										base_amount={
											op[1].new_options.core_exchange_rate.base.amount
										}
										quote_amount={
											op[1].new_options.core_exchange_rate.quote.amount
										}
										noPopOver
									/>
								</td>
					...
					rows.push(
						<tr key={key++}>
							...
							<td>
								<Inspector data={op[1].new_options} search={false} />
							</td>
						</tr>
					);
				...
				case 'asset_burn':
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="explorer.account.title" />
							</td>
				...
				case 'asset_fund_fee_pool':
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="explorer.asset.title" />
							</td>
				...
				case 'asset_publish_feed':
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="transaction.publisher" />
							</td>
					...
					rows.push(
						<tr key={key++}>
							...
							<td>
								<FormattedPrice
									base_asset={
										asset_utils.extractRawFeedPrice(feed).base.asset_id
									}
									quote_asset={
										asset_utils.extractRawFeedPrice(feed).quote.asset_id
									}
									base_amount={
										asset_utils.extractRawFeedPrice(feed).base.amount
									}
									quote_amount={
										asset_utils.extractRawFeedPrice(feed).quote.amount
									}
									noPopOver
								/>
							</td>
				...
				case 'witness_create':
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="explorer.block.witness" />
							</td>
				...
				case 'witness_update':
					...
					if (op[1].new_url) {
						rows.push(
							<tr key={key++}>
								<td>
									<Translate component="span" content="transaction.new_url" />
								</td>
								<td>
									<a
										href={op[1].new_url}
				...
				case 'balance_claim':
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="transaction.claimed" />
							</td>
							<td>
								<FormattedAsset
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="transaction.deposit_to" />
							</td>
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="transaction.balance_id" />
							</td>
							<td>#{bal_id}</td>
						</tr>
					);
				...
				case 'transfer_to_blind':
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="transaction.outputs" />
							</td>
							<td>
				...
				case 'transfer_from_blind':
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="transaction.inputs" />
							</td>
							<td>
				...
				case 'proposal_update':
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="proposal_create.id" />
							</td>
							<td>{op[1].proposal}</td>
						</tr>
					);
					...
					fields.forEach((field) => {
						if (op[1][field].length) {
							rows.push(
								<tr key={key++}>
									<td>
										<Translate content={`proposal.update.${field}`} />
									</td>
									<td>
				...
				case 'proposal_delete':
					...
					rows.push(
						<tr key={key++}>
							...
							<td>
								<TranslateBoolean value={op[1].using_owner_authority} />
							</td>
						</tr>
					);
					rows.push(
				...
				case 'worker_create':
					...
					let endDate = counterpart.localize(new Date(op[1].work_end_date), {
						type: 'date',
					});
				...
				case 'htlc_create':
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="htlc.claim_period_due" />
							</td>
							<td>
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="htlc.preimage_hash" />
							</td>
							<td>
								<Tooltip
									placement="bottom"
				...
				case 'htlc_redeem':
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="htlc.redeemer" />
							</td>
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="htlc.preimage" />
							</td>
				...
				case 'htlc_extend':
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="htlc.update_issuer" />
							</td>
					...
					rows.push(
						<tr key={key++}>
							<td>
								<Translate component="span" content="htlc.seconds_to_add" />
							</td>
							<td>
