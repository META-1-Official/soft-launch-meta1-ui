...
import {Radio, Tooltip, Button, Form} from 'antd';
			...
			<div>
				...
				>
					...
					>
						...
						<Radio
							value={
								!this.state.customPrice ? 2 : this.state.globalSettlementPrice
							}
						>
					...
					<div style={{paddingTop: '1rem'}} className="button-group">
						<Button
							type="primary"
							disabled={
								this.state.globalSettlementPrice == null ? true : undefined
							}
