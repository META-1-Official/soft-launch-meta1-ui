...
import {ChainStore, FetchChain, key} from 'meta1-vision-js';
...
class CreateAccountPassword extends React.Component {
	...
	_onInput(value, e) {
		this.setState({
			[value]:
				value === 'confirm_password' ? e.target.value : !this.state[value],
			validPassword:
				...
				>
					...
					<section className="form-group">
						<label className="left-label">
							...
							&nbsp;&nbsp;
							<Tooltip title={counterpart.translate('tooltip.generate')}>
								<span className="tooltip">
									<Icon name="question-circle" title="icons.question_circle" />
								</span>
							</Tooltip>
						</label>
					...
					<section>
						...
						this.state.confirm_password !== this.state.generatedPassword ? (
