...
import {Modal, Button, notification, Switch, Tooltip} from 'antd';
...
class AccountAssetUpdate extends React.Component {
	...
	constructor(props) {
		...
		this.showAssetUpdateConfirmationModal =
			this.showAssetUpdateConfirmationModal.bind(this);
		this.hideAssetUpdateConfirmationModal =
			this.hideAssetUpdateConfirmationModal.bind(this);
	}
	...
	_getCurrentSupply() {
		...
		return (
			getDynamicObject &&
			getDynamicObject(asset.get('dynamic_asset_data_id')).get('current_supply')
		);
	}
