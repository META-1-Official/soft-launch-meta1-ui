		...
		return (
			<tr className="margin-row">
				...
				<td style={{textAlign: 'center'}}>
					<Link
						to={`/market/${debtAsset.get('symbol')}_${collateralAsset.get(
							'symbol'
						)}`}
					>
						<Icon
				...
				<td>
					{has_order ? (
						<div
							data-place="left"
							data-tip={counterpart.translate('tooltip.close_position', {
								amount: utils.get_asset_amount(co.debt, this.props.debtAsset),
