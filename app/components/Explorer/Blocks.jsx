    ...
    render() {
        ...
        return (
            <div className="padding">
                <div
                    ref="outerWrapper"
                    className="grid-block vertical explore-panels"
                >
                    {/* First row of stats */}
                    ...
                    <div
                        ...
                        className="grid-block no-overflow recent-block"
                    >
                        <div className="grid-block small-12 medium-6 vertical no-overflow">
                            <div className="grid-block vertical no-overflow generic-bordered-box">
                                ...
                                <div
                                    className="grid-block ant-table ant-table-default"
                                    style={{
                                    ...
                                    ref="operations"
                                >
                                    <table className=" fixed-height-2rem">
