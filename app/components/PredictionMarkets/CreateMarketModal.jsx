...
export default class CreateMarketModal extends Modal {
	...
	handleAssetChange(asset) {
		if (asset) {
			...
			newMarketOptions.precision = ChainStore.getAsset(asset).get('precision');
				...
				<div>
					<Form className="full-width" layout="vertical">
						<Form.Item>
							<span
								className={
									(!marketOptions.symbol && showWarning) || wrongSymbol
										? 'has-error'
										: ''
								}
							>
						...
						<Form.Item>
							<span
								className={
									!marketOptions.description.condition && showWarning
										? 'has-error'
										: ''
								}
							>
						...
						<Form.Item>
							<span
								className={
									(!marketOptions.description.expiry && showWarning) ||
									wrongDate
										? 'has-error'
										: ''
								}
