				...
				<div className="exchange--price-alert">
					<div className="exchange--price-alert--description">
						{this.state.rules.length ? (
							<div>
								{counterpart.translate('exchange.price_alert.alert_when')}{' '}
							...
							<div>
								{counterpart.translate('exchange.price_alert.use_button')}
								<Link to={linkToExchange}>
									<AssetName name={quoteAssetSymbol} />/
									<AssetName name={baseAssetSymbol} />
								</Link>
									...
									>
										...
										>
											...
											>
												...
												<Select.Option
													value={PRICE_ALERT_TYPES.LOWER_THAN}
													key={'2'}
												>
													{counterpart.translate(
											...
											<Input
												...
												addonAfter={<AssetName name={baseAssetSymbol} />}
											/>
