...
Merkezsiz borsa (kısaca *DEX*) , META1 ekosisteminde 
...
Bunlardan kısaca bahsetmek istiyoruz. META1 DEX'de hepsi mevcut olmasina 
...
* **Güçler Ayrılığı** : 
  ...
  kimsenin sorumlu olmasını gerektirecek bir sebep yoktur. META1'de işlem 
...
* **Genel Birleşik Emir/Sipariş Defteri** :
  META1 evrensel olduğu için , internet erişimi olan herkes  DEX'i alım-satım için 
...
* **Neredeyse Herşeyi Alıp-Satabilirsiniz** :
  ...
  için USDT:EUR gibi eşleşmeler çok büyük hacimli işlem görür.
* **Limit Yok** :
...
* **Merkezsiz** :
  ...
  olmadığı gibi bu META1 borsasının ticaret için 7/24 açık olduğu anlamına 
...
* **Hızlı** :
  Diğer merkezsiz ağların tersine META1 DEX gerçek-zamanlı ticarete
   imkan tanır , sadece ışık hızı ve gezegenin büyüklüğü 
  ile sınırlıdır.
* **Kanıtlanabilir Emir Eşleştirme Algoritması** :
  META1 DEX i nadir kılan şeylerden biri de ispatlanabilir emir eşleştirme 
...
* **Teminata Bağlanmış** :
  ...
  *akıllıparalar*dır. Kolaylık olsun diye bu varlıklar cüzdan içerisinde USDT,EUR,CNY 
  diye kısaltılmışlardır. Bu dijital kuponlar dayandıkları fiziksel varlıkla aynı değeri 
  temsil ederler. Yani bu cüzdandaki 1 USDT nin değeri 1 dolardır ve o şekilde 
