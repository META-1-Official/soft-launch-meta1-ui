...
In order to increase your exposure to META and offer liquidity to BitAssets, such
 ...
 * *settlement price*: The price for 1 META as it is traded on external exchanges.
...
offer to buy the collateral is less than the call price (x/META).
...
market rates up to the SQP and close the position. The remaining META of the
...
increase, an additional amount of META is locked as collateral, while reducing
