...
class SettingsStore {
    ...
    init() {
        return new Promise(resolve => {
            ...
            let topMarkets = {
                markets_3dbdca40: getMyMarketsQuotes(),
                markets_39f5e2ed: [
                    // TESTNET
                    "PEG.FAKEUSD",
                    "BTWTY"
            ...
            let bases = {
                markets_3dbdca40: getMyMarketsBases(),
                markets_39f5e2ed: [
                    // TESTNET
                    "TEST"
                ]
            ...
            let defaultBases = bases[this.starredKey] || bases.markets_3dbdca40;
