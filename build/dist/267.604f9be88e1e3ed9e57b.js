(this.webpackChunkBitShares2_light =
	...
	{
		58267: (e, r, t) => {
			(t.g.IntlPolyfill = t(98659)),
				t(12482),
				t.g.Intl ||
					((t.g.Intl = t.g.IntlPolyfill),
					t.g.IntlPolyfill.__applyLocaleSensitivePrototypes()),
				(e.exports = t.g.IntlPolyfill);
		},
		98659: (e, r, t) => {
			'use strict';
			var n,
					...
					slicedToArrayLoose: function (e, r) {
						...
						if (Symbol.iterator in Object(e)) {
							for (
								...
								!(t = a.next()).done && (n.push(t.value), !r || n.length !== r);
				...
				v = g
					...
					: function (e, r, t) {
							'get' in t && e.__defineGetter__
								...
								: (m.call(e, r) && !('value' in t)) || (e[r] = t.value);
					  },
				h =
				...
				j =
					...
					function (e) {
						...
						return (
							r.length,
							function () {
								return r.apply(e, y.call(t, p.call(arguments)));
							}
						);
					},
				z = d(null),
			...
			function S(e) {
				...
				return 'object' === (void 0 === e ? 'undefined' : u.typeof(e))
					? e
					: Object(e);
			}
			function E(e) {
			...
			var L = RegExp(
				...
				_ = RegExp('-[0-9a-wy-z](?:-[a-z0-9]{2,8})+', 'ig'),
				M = void 0,
				I = {
					tags: {
						'art-lojban': 'jbo',
			...
			function R(e) {
				return !!L.test(e) && !N.test(e) && !T.test(e);
			}
			function q(e) {
				for (
					var r = void 0,
				...
				(r = (e = w.call(t, '-')).match(_)) &&
					r.length > 1 &&
					(r.sort(),
					(e = e.replace(RegExp('(?:' + _.source + ')+', 'i'), w.call(r, '')))),
					m.call(I.tags, e) && (e = I.tags[e]);
				for (var i = 1, o = (t = e.split('-')).length; i < o; i++)
					m.call(I.subtags, t[i])
						? (t[i] = I.subtags[t[i]])
						: m.call(I.extLang, t[i]) &&
						  ((t[i] = I.extLang[t[i]][0]),
						  1 === i &&
								I.extLang[t[1]][1] === t[0] &&
								((t = p.call(t, i++)), (o -= 1)));
				...
				for (
					...
					if (i in t) {
						...
						if (
							null === o ||
							('string' != typeof o &&
								'object' !== (void 0 === o ? 'undefined' : u.typeof(o)))
						)
			...
			function U(e, r) {
				for (
					...
					(i = r[t]), (a = Z(e, (o = String(i).replace(G, '')))), t++;
				var s = new k();
				if (void 0 !== a) {
			...
			function K(e, r) {
				for (var t = r.length, n = new O(), a = 0; a < t; ) {
					var i = r[a];
					void 0 !== Z(e, String(i).replace(G, '')) && b.call(n, i), a++;
				}
				return p.call(n);
			}
			function Y(e, r, t) {
				...
				if (
					void 0 !== t &&
					void 0 !== (a = (t = new k(S(t))).localeMatcher) &&
					'lookup' !== (a = String(a)) &&
					'best fit' !== a
				)
				...
				for (var i in (n =
					void 0 === a || 'best fit' === a
						...
						: K(e, r)))
					m.call(n, i) &&
						v(n, i, {writable: !1, configurable: !1, value: n[i]});
				return v(n, 'length', {writable: !1}), n;
			}
			...
			var X = {};
			Object.defineProperty(X, 'getCanonicalLocales', {
				enumerable: !1,
				configurable: !0,
				writable: !0,
				value: function (e) {
					for (var r = B(e), t = [], n = r.length, a = 0; a < n; )
						(t[a] = r[a]), a++;
					return t;
				},
			});
			...
			function J() {
				var e = arguments[0],
					r = arguments[1];
				return this && this !== X ? Q(S(this), e, r) : new X.NumberFormat(e, r);
			}
			function Q(e, r, t) {
				var n = P(e),
					a = F();
				...
				var l = z.NumberFormat['[[localeData]]'],
					c = $(
						...
						i,
						o,
						z.NumberFormat['[[relevantExtensionKeys]]'],
						l
					);
				(n['[[locale]]'] = c['[[locale]]']),
				...
				n['[[style]]'] = g;
				var m,
					h = H(t, 'currency', 'string');
				if (void 0 !== h && ((m = A(String(h))), !1 === C.test(m)))
					throw new RangeError("'" + h + "' is not a valid currency code");
				if ('currency' === g && void 0 === h)
					throw new TypeError(
				...
				'currency' === g && (n['[[currencyDisplay]]'] = y);
				var b = W(t, 'minimumIntegerDigits', 1, 21, 1);
				n['[[minimumIntegerDigits]]'] = b;
				var w = W(t, 'minimumFractionDigits', 0, 20, 'currency' === g ? p : 0);
				...
				var j = t.minimumSignificantDigits,
					E = t.maximumSignificantDigits;
				(void 0 === j && void 0 === E) ||
					((j = W(t, 'minimumSignificantDigits', 1, 21, 1)),
					(E = W(t, 'maximumSignificantDigits', j, 21, 21)),
					(n['[[minimumSignificantDigits]]'] = j),
					(n['[[maximumSignificantDigits]]'] = E));
				var L = H(t, 'useGrouping', 'boolean', void 0, !0);
				n['[[useGrouping]]'] = L;
				var N = l[u].patterns[g];
				return (
					(n['[[positivePattern]]'] = N.positivePattern),
					(n['[[negativePattern]]'] = N.negativePattern),
					(n['[[boundFormat]]'] = void 0),
					(n['[[initializedNumberFormat]]'] = !0),
					f && (e.format = ee.call(e)),
					a(),
					e
				);
			}
			function ee() {
				var e = null !== this && 'object' === u.typeof(this) && P(this);
			...
			function re(e, r) {
				for (var t = te(e, r), n = [], a = 0, i = 0; t.length > i; i++) {
					var o = t[i],
						s = {};
					(s.type = o['[[type]]']),
						(s.value = o['[[value]]']),
			...
			function te(e, r) {
				...
				!isNaN(r) && r < 0
					...
					: (s = t['[[positivePattern]]']);
				for (
					var l = new O(), c = s.indexOf('{', 0), u = 0, g = 0, f = s.length;
					c > -1 && c < f;
					...
					if ('number' === h)
							...
							if (
								...
								if (y.length > F) {
									var E = y.length - F,
										L = E % S,
										N = y.slice(0, L);
									for (N.length && b.call(k, N); L < E; )
										b.call(k, y.slice(L, L + S)), (L += S);
									b.call(k, y.slice(E));
								} else b.call(k, y);
								if (0 === k.length) throw new Error();
								for (; k.length; ) {
									var T = x.call(k);
									b.call(l, {'[[type]]': 'integer', '[[value]]': T}),
										k.length &&
											b.call(l, {'[[type]]': 'group', '[[value]]': D});
								}
							} else b.call(l, {'[[type]]': 'integer', '[[value]]': y});
							if (void 0 !== w) {
								var _ = o.decimal;
								b.call(l, {'[[type]]': 'decimal', '[[value]]': _}),
									b.call(l, {'[[type]]': 'fraction', '[[value]]': w});
							}
						} else {
							var M = o.infinity;
							b.call(l, {'[[type]]': 'infinity', '[[value]]': M});
						}
					else if ('plusSign' === h) {
						var I = o.plusSign;
						...
						var A = o.minusSign;
						b.call(l, {'[[type]]': 'minusSign', '[[value]]': A});
						...
						'code' === t['[[currencyDisplay]]']
							...
							b.call(l, {'[[type]]': 'currency', '[[value]]': C});
					} else {
				...
				if (g < f) {
					var B = s.substring(g, f);
					b.call(l, {'[[type]]': 'literal', '[[value]]': B});
				}
				return l;
			}
			function ne(e, r) {
			...
			function ae(e, r, t) {
				...
				if (
					(i >= 0
						...
						: i < 0 && (a = '0.' + w.call(Array(1 - (i + 1)), '0') + a),
					a.indexOf('.') >= 0 && t > r)
				) {
			...
			function ie(e, r, t, n) {
				...
				if (0 !== i) {
					var u = s.length;
					u <= i && ((s = w.call(Array(i + 1 - u + 1), '0') + s), (u = i + 1));
				...
				return (
					...
					c < r && (s = w.call(Array(r - c + 1), '0') + s),
					s
				);
			}
			v(X, 'NumberFormat', {configurable: !0, writable: !0, value: J}),
				v(X.NumberFormat, 'prototype', {writable: !1}),
				(z.NumberFormat = {
					'[[availableLocales]]': [],
					'[[relevantExtensionKeys]]': ['nu'],
					'[[localeData]]': {},
				}),
				v(X.NumberFormat, 'supportedLocalesOf', {
					configurable: !0,
					writable: !0,
				...
				v(X.NumberFormat.prototype, 'format', {configurable: !0, get: ee}),
				Object.defineProperty(X.NumberFormat.prototype, 'formatToParts', {
					configurable: !0,
					enumerable: !1,
					writable: !0,
					value: function () {
						var e =
								arguments.length <= 0 || void 0 === arguments[0]
									? void 0
									: arguments[0],
							r = null !== this && 'object' === u.typeof(this) && P(this);
			...
			v(X.NumberFormat.prototype, 'resolvedOptions', {
				configurable: !0,
				writable: !0,
				value: function () {
					var e = void 0,
						...
						n = null !== this && 'object' === u.typeof(this) && P(this);
			...
			function he(e) {
				return (
					...
					(e.pattern = e.pattern12.replace('{ampm}', '').replace(le, '')),
					e
				);
			}
			function de(e, r) {
			...
			function je(e, r, t) {
				...
				var d = g['[[dataLocale]]'],
					p = t.timeZone;
				if (void 0 !== p && 'UTC' !== (p = A(p)))
					throw new RangeError('timeZone is not supported.');
				for (var y in ((n['[[timeZone]]'] = p), (o = new k()), ze))
					if (m.call(ze, y)) {
						var b = H(t, y, 'string', ze[y]);
						o['[[' + y + ']]'] = b;
					}
				var w = void 0,
					x = u[d],
						...
						return '[object Array]' === Object.prototype.toString.call(e)
							...
							: (function (e) {
									...
									for (i in r)
										r.hasOwnProperty(i) &&
											(s = pe(i, (o = r[i]))) &&
											(a.push(s), fe(s) ? g.push(s) : me(s) && u.push(s));
									for (i in t)
										t.hasOwnProperty(i) &&
											(s = pe(i, (o = t[i]))) &&
											(a.push(s), u.push(s));
										...
										for (c = 0; c < g.length; c += 1)
											(o =
												'long' === g[c].month
													...
													? e.medium
													: e.short),
												((s = ve(g[c], u[l])).originalPattern = o),
												(s.extendedPattern = o
				...
				if (
					...
					var S = H(t, 'hour12', 'boolean');
					(o.hour12 = void 0 === S ? x.hour12 : S),
						(w = (function (e, r) {
							var t = [];
							for (var n in ze)
								m.call(ze, n) && void 0 !== e['[[' + n + ']]'] && t.push(n);
							if (1 === t.length) {
								var a = (function (e, r) {
									var t;
									if (ye[e] && ye[e][r])
							...
							for (var i = -1 / 0, o = void 0, l = 0, c = r.length; l < c; ) {
								var u = r[l],
									g = 0;
								for (var f in ze)
									if (m.call(ze, f)) {
										var v = e['[[' + f + ']]'],
											d = m.call(u, f) ? u[f] : void 0;
										if (
											(v !== (m.call(u._, f) ? u._[f] : void 0) && (g -= 2),
											void 0 === v && void 0 !== d)
										)
											g -= 20;
										else if (void 0 !== v && void 0 === d) g -= 120;
										else {
				...
				for (var E in ze)
					if (m.call(ze, E) && m.call(w, E)) {
						var L = w[E];
						(L = w._ && m.call(w._, E) ? w._[E] : L), (n['[[' + E + ']]'] = L);
					}
				var N = void 0,
					T = H(t, 'hour12', 'boolean');
				if (n['[[hour]]'])
					if (
						((T = void 0 === T ? x.hour12 : T), (n['[[hour12]]'] = T), !0 === T)
					) {
						var _ = x.hourNo0;
			...
			v(X, 'DateTimeFormat', {configurable: !0, writable: !0, value: xe}),
				v(xe, 'prototype', {writable: !1});
			var ze = {
			...
			function De(e, r, t) {
				...
				return (
					('date' !== r && 'any' !== r) ||
						...
						(i = !1),
					('time' !== r && 'any' !== r) ||
						(void 0 === e.hour && void 0 === e.minute && void 0 === e.second) ||
						(i = !1),
					!i ||
						('date' !== t && 'all' !== t) ||
			...
			function Oe(e, r) {
				...
				for (
					var n,
						...
						o,
						s = t['[[locale]]'],
						l = new X.NumberFormat([s], {useGrouping: !1}),
						c = new X.NumberFormat([s], {
					...
					v > m && b.call(f, {type: 'literal', value: g.substring(m, v)});
					...
					if (ze.hasOwnProperty(x)) {
						...
						if (
							...
							(w = ne(c, S)).length > 2 && (w = w.slice(-2));
						else if (j in be)
							switch (x) {
								case 'month':
									w = we(p, y, 'months', j, u['[[' + x + ']]']);
									break;
								case 'weekday':
									try {
										w = we(p, y, 'days', j, u['[[' + x + ']]']);
						...
						'ampm' === x
							...
							: b.call(f, {type: 'literal', value: g.substring(v, h + 1)});
					(m = h + 1), (v = g.indexOf('{', m));
				}
				return (
					h < g.length - 1 &&
						b.call(f, {type: 'literal', value: g.substr(h + 1)}),
					f
				);
			}
			function Fe(e, r) {
			...
			(z.DateTimeFormat = {
				...
				v(X.DateTimeFormat, 'supportedLocalesOf', {
					configurable: !0,
					writable: !0,
					value: j.call(function (e) {
						if (!m.call(this, '[[availableLocales]]'))
				...
				v(X.DateTimeFormat.prototype, 'format', {configurable: !0, get: ke}),
				Object.defineProperty(X.DateTimeFormat.prototype, 'formatToParts', {
					enumerable: !1,
					writable: !0,
					configurable: !0,
					value: function () {
						...
						var t = void 0 === e ? Date.now() : E(e);
						return Se(this, t);
					},
				}),
				v(X.DateTimeFormat.prototype, 'resolvedOptions', {
					writable: !0,
					configurable: !0,
					value: function () {
						var e = void 0,
			...
			var Ee = (X.__localeSensitiveProtos = {Number: {}, Date: {}});
			(Ee.Number.toLocaleString = function () {
				if ('[object Number]' !== Object.prototype.toString.call(this))
					throw new TypeError(
						'`this` value must be a number for Number.prototype.toLocaleString()'
					);
				return ne(new J(arguments[0], arguments[1]), this);
			}),
				(Ee.Date.toLocaleString = function () {
					...
					var r = arguments[0],
						t = arguments[1],
						n = new xe(r, (t = De(t, 'any', 'all')));
					return Fe(n, e);
				}),
				(Ee.Date.toLocaleDateString = function () {
					if ('[object Date]' !== Object.prototype.toString.call(this))
						throw new TypeError(
					...
					var r = arguments[0],
						t = arguments[1],
						n = new xe(r, (t = De(t, 'date', 'date')));
					return Fe(n, e);
				}),
				(Ee.Date.toLocaleTimeString = function () {
					if ('[object Date]' !== Object.prototype.toString.call(this))
						throw new TypeError(
					...
					var r = arguments[0],
						t = arguments[1],
						n = new xe(r, (t = De(t, 'time', 'time')));
					return Fe(n, e);
				}),
				v(X, '__applyLocaleSensitivePrototypes', {
					writable: !0,
					configurable: !0,
					value: function () {
						for (var e in (v(Number.prototype, 'toLocaleString', {
							writable: !0,
							configurable: !0,
							value: Ee.Number.toLocaleString,
						}),
						v(Date.prototype, 'toLocaleString', {
							writable: !0,
							configurable: !0,
							value: Ee.Date.toLocaleString,
						}),
						Ee.Date))
							m.call(Ee.Date, e) &&
								v(Date.prototype, e, {
					...
					value: function (e) {
						...
						!(function (e, r) {
							...
							for (
								...
								b.call(z.NumberFormat['[[availableLocales]]'], t),
									(z.NumberFormat['[[localeData]]'][t] = e.number),
									e.date &&
										((e.date.nu = e.number.nu),
										b.call(z.DateTimeFormat['[[availableLocales]]'], t),
										(z.DateTimeFormat['[[localeData]]'][t] = e.date));
							void 0 === M &&
								(function (e) {
									M = e;
								})(r);
